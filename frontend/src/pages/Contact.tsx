...
const servicesList = ["Dossier Campus France", "Lettres de motivation", "Simulation d'entretien", "Pack complet", "Autre demande"];
          ...
          <div className="grid lg:grid-cols-5 gap-12">
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div className="space-y-6">
                {[
                  { icon: Mail, label: "Email", value: "contact@maigup-france.com" },
